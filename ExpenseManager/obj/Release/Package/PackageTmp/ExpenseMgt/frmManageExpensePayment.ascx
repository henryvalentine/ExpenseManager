...
<div class="dvContainer">
                  ...
                  <tr>
                   ...
                   <tr>
                       ...
                       <td  style="width: 20px;text-align: right; font-weight: bold" class="tdpadd">
                        <asp:LinkButton runat="server" ID="lnkContinue" Text="&nbsp;Continue >>" ForeColor="#ffffff" CssClass="nextbtn" OnClick="LnkContinueClick"></asp:LinkButton>   
                       </td>
                   </tr>
                </table>
            </fieldset>
                                        ...
                                        <table style="width: 100%; height: 190px; ">
                                            ...
                                            <tr>
                                                <td class="tdpad">
                                                  ...
                                                  <input type="text" id="txtChequeAmount" ClientIDMode="Static" class="text-box" style="" runat="server" onkeyup="return calaculateChequeBalance()" onchange="return calaculateChequeBalance()"/>
                                               </td>
                                            </tr>
                                            <tr>
                                                <td class="tdpad" >
   ...
   <script type="text/javascript">
       ...
       function calaculateBalance() {
           $('#txtAmountPaid').formatCurrency({ symbol: '', roundToDecimalPlace: 0 });
