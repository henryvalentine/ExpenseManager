  ...
  <div class="dvContainer">
   ...
   <div style="width: 100%;" class="gridDiv" runat="server" id="dvTransactionItems">
                ...
                <HeaderStyle CssClass="gridHeader" />
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <input type="checkbox" id="chkSelect<%# (DataBinder.Eval(Container.DataItem,"TransactionItemId")) %>" onclick="CheckChanged(this.id);" name="selectOption" style="margin-left: 38%"/>
                            </ItemTemplate>
                        </asp:TemplateColumn>
           ...
           <tr>
               ...
               <td style="width: 50%" class="tdpadd">
                 <div style="width: 40%; margin-left: 40%; margin-top: -10%">
                   ...
                   Select the needed Items of the Transaction individually or Check <b>All</b> to select all Items, then Tick the <b>Approve</b> option to Approve the Transaction.
                  </label>
                 </div>
              </td>
           </tr>
    ...
    <script type="text/javascript">
        ...
        var rdVoidItd = document.getElementById('<%=radApprove.ClientID%>');
        var rejectTransRd = document.getElementById('<%=radReject.ClientID%>');
        var voidTransRd = document.getElementById('<%=radVoid.ClientID%>');
        var selctListC = document.getElementsByName("selectOption");
        ...
        function CheckChanged(id)
        {
            if ($('#' + id).is(':checked'))
            {
                ...
                if (rejectTransRd.checked == true) 
                {
                    rejectTransRd.checked = false;
                }
                ...
                var dt = id.split('t');
                idArray.splice($.inArray(dt[1], idArray), 1);
                SendIds();
            }
        }
        ...
        function CheckAllChanged(id) 
        {
            ...
            if ($('#' + id).is(':checked')) 
            {
                ...
                idCollection = "";
                idArray = [];
                for (var i = 0; i < selctListC.length; i++)
                {
                    selctListC[i].checked = true; 
                    var tf = selctListC[i].id.split('t');
                    if (parseInt(tf[1]) > 0) 
                    {
                         idArray.push(tf[1]);
                ...
                for (var j = 0; j < selctListC.length; j++)
                {
                    if (selctListC[j].checked)
                    {
                        selctListC[j].checked = false;
                        idArray = [];
                        idCollection = "";
        ...
        {
            idCollection = '';
            if (rdVoidItd.checked == true && rdVoidItd.value === "Approve" && idArray.length > 0)
            {
        ...
        {
            var slctListC = document.getElementsByName("selectOption");
            var slctAll = document.getElementById("chkAll");
            if ($('#' + id).is(':checked')) 
            {
         ...
         function calculateTotalPrice() 
        {
            ...
            $('#txtTransTotalPrice').val('');
             var approvedQuantityString = $('#<%= textApprouvedQuantity.ClientID%>').val();
             var approvedUnitPriceString = $('#<%= textApprovedUnitPrice.ClientID %>').val();
        ...
        function showItems(retData) 
        {
            ...
            if (retItemData === null || retItemData.length < 1) 
            {
