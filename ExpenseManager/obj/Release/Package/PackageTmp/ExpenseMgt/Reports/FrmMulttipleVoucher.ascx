      ...
      <table style="width: 100%">
         ...
         <tr class="divBackground3">
            ...
            <label class="label3">Department</label>
             ...
             <td class="tdpad" style="width: 15%">
                <asp:DropDownList runat="server" ID="ddlDepartmentVoucher" ClientIDMode="Static" 
                     Width = "93%" class="text-box"></asp:DropDownList> 
            </td>
        ...
        <div id="MultiDiv" style=" width: 100%" class="gridDiv">
         ...
         <table style="width: 100%;">
             <tr>
                 ...
                 <td style="width: 30%">
                     <input class="customButton" type="button" value="Preview Selection" style="width: 130px; margin-left: 40%; margin-top: 3%" onclick="SendOptionIds()" id="btnPrintSelection"/>
                 </td>
             </tr>
         </table>
      </div>
      <div id="dvPreviewMultiple" style="visibility: visible; display: none; margin-top: 1%; width: 100%">
           <table style="width: 100%;">
             <tr>
                 <td style="width: 80%">
                 </td>
                 <td style="width: 20%">
                     <input class="customButton" type="button" value="<< Back" style="width: 115px; margin-left: 40%" onclick="HideDivs()" id="btnBack"/>
                 </td>
             </tr>
         </table>
         <div id="dvItemsView" style="margin-top: 1%; width: 73%; margin-left: 10%"></div>
         <table style="width: 100%;">
             <tr>
                 <td style="width: 80%">
                 </td>
                 <td style="width: 20%">
                     <input class="customButton" type="button" value="Print" style="width: 115px; margin-left: 40%; margin-top: 3%; margin-bottom: 5%" onclick="printSelection()" id="btnPrintSelected"/>
                 </td>
             </tr>
         </table>
      </div>
