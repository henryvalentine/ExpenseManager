...
<link href="App_Themes/Default/ControlStyles.css" rel="stylesheet" type="text/css" />
  ...
  <%-- 
  <script language='javascript' ID='paymentVoucherManager'>


      function getFormatedAmountInWords(totalPrice, naira, kobo)
      {
          var xVal = numbersToWord(paymentHistory.TotalApprovedAmmount, naira, kobo);
