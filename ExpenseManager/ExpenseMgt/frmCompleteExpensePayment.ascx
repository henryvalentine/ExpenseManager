                            ...
                            <table style="border-style: none; border-color: inherit; border-width: medium; width:100%; height: 171px;" runat="server" id="Table2">
                                <tr>
                                    <td colspan="2">
                                        <table style="width: 100%; height: 190px; ">
                                            <tr>
                                               <td style="width: 50%; vertical-align: top" class="tdpad">
                                               ...
                                               <td style="width: 50%; vertical-align: top" rowspan="4" class="tdpad">
                                                  <div style="width: 100%; margin-left: 2%;  vertical-align: top"> 
                                                       <div style="width: 96%;">
                                                       <img src="../App_Themes/Default/Images/defaultImage.jpg" alt="Cheque Copy" id="imgChequeUpdate" 
                                                               style="width: 305px; height: 201px; vertical-align: top;" /> 
                                                       <div style="width: 304px"><i>New Cheque Copy</i>(<span style="color: Red; font-size: 10pt">*jpeg/jpg only. 500KB Maximum</span>)</div>
                                            ...
                                            <tr>
                                                <td class="tdpad">
                                                  ...
                                                  <input type="text" id="txtChequeAmountToPay" ClientIDMode="Static" class="text-box" style="width: 97%;" runat="server" onchange="return calaculateChequeBalance()"/>
                                               </td>
                                            </tr>
                                            <tr>
                                                <td class="tdpad" >
                                ...
                                <tr>
                                    <td colspan="2" class="tdpad" >
                                        ...
                                        <div style="width: 97%; height: 89px;">
                                           <asp:TextBox runat="server" ID="txUpdateChequePaymentChequeComment" TextMode="MultiLine" ClientIDMode="Static" Width="100%" Rows="6" Height="84%"></asp:TextBox>
                                        </div>
                                    </td>
                                 </tr>
                                 <tr>
                                    ...
                                    <td style="width: 50%">
                                       <div style="width: 60%; margin-left: 30%; margin-top: 7%">
    ...
    <div style="width: 100%; margin-top: 5px; " class="gridDiv" >
     ...
     <script type="text/javascript">
         function calaculateChequeBalance() 
         {
             ...
             $('#txtChequeAmountToPay').val(accounting.formatMoney($('#txtChequeAmountToPay').val(), { symbol: "", format: "%v %s" }));
         ...
         function calaculateBalance() {
             ...
             $('#txtUpdateAmount').val(accounting.formatMoney($('#txtUpdateAmount').val(), { symbol: "", format: "%v %s" }));
