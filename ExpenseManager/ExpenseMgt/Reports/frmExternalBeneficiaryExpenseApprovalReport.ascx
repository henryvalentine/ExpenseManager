<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="frmExternalBeneficiaryExpenseApprovalReport.ascx.cs" Inherits="ExpenseManager.ExpenseMgt.Reports.FrmApprovalReport1" %>
...
<%@ Register TagPrefix="uc2" TagName="ErrorDisplay" Src="~/CoreFramework/ErrorControl/ErrorDisplay.ascx" %>
    ...
    <h2 style=" font-weight: normal; font-family: 'OCR A Extended', arial; border-bottom-color: #038103; margin-top: 1.3%">
        &nbsp;Transaction Approvals for External Beneficiaries</h2>
     ...
     <div runat="server" id="divReport" style="width: 99%; padding: 1px;" class="gridDiv">
        <table border="0" cellspacing="0" cellpadding="2" width="100%" runat="server" id="tbExpenseType">
            <tbody>
				     ...
				     <table style="border-style: none; border-color: inherit; border-width: medium; width: 100%; padding: 0px; height: 38px;">
					    <tr>
						   <td style="width: 20%" class="divBackground">
						        ...
						        <label style="color: #038103; font-family: 'OCR A Extended', arial;">Approved Transactions</label></div>
                            </td>
              ...
              <tr>
                <td style="width: 100%">
                    <asp:DataGrid ID="dgApprovedTransactions" runat="server" AutoGenerateColumns="False" CellPadding="1" CellSpacing="1" GridLines="none" CssClass="xPlugTextAll_x"  DataKeyField="ExpenseApprovalId" ShowFooter="True" Width="100%">
                        ...
                        <HeaderStyle CssClass="gridHeader" />
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="Transaction" >
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblTitle" runat="server"  CssClass="xPlugTextAll_x" Text='<%# (DataBinder.Eval(Container.DataItem,"ExpenseTransaction.ExpenseTitle")) %>'>
                                        </asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                                ...
                                <asp:TemplateColumn HeaderText="Time Approved" >
                                 ...
                                 <asp:TemplateColumn HeaderText="Approved By" >
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblStatus" runat="server" CssClass="xPlugTextAll_x" Text='<%#  ((DataBinder.Eval(Container.DataItem,"ExpenseTransaction.Status")).ToString() == "1")? "Approved" : "Not Approved"%>'>
                                        </asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                               </Columns>
