<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FrmAccountsHeadReport.ascx.cs" Inherits="ExpenseManager.ExpenseMgt.Reports.FrmAccountsHeadReport" %>
...
<div class="dvContainer">
    <h2 runat="server" id="hTitle">Cost Reports By Account Heads</h2>	
    ...
    <table style="width: 100%">
        <tr>
            ...
            <label style="width: 100%">
                Note on <b>FILTERING</b>: &nbsp;Select an <b>Account Head</b> and then get it's cost 
        ...
        <tr class="divBackground3">
            ...
            <td class="tdpad" style="width: 35%">
                <asp:DropDownList runat="server" ID="ddlAccountsHeads" Width="100%" CssClass="text-box"></asp:DropDownList>    
            </td>
       ...
       <tr class="gridFoot">
           <td colspan="5" style="font-weight: bold"><br/>
               Account Head: 
              <label id="headTitle" runat="server" style="color: green; width: auto"></label><br/><br/>
           </td>
       ...
       <tr>
            <td style="width: 100%" colspan="7">
                 <asp:DataGrid ID="dgCostItems" runat="server" AutoGenerateColumns="False" CellPadding="1" CellSpacing="1" GridLines="none" CssClass="xPlugTextAll_x" DataKeyField="TransactionItemId" 
                          ...
                          <HeaderStyle CssClass="gridHeader" />
                            <Columns>
                                ...
                                <%--<asp:TemplateColumn HeaderText="Quantity" >
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblApprovedQuantity"  runat="server"  Text='<%#(DataBinder.Eval(Container.DataItem,"ApprovedQuantity"))%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>--%>
                                ...
                                <asp:TemplateColumn HeaderText="Total Price Per Period(N)" >
                                    <HeaderStyle HorizontalAlign="Left" Width="12%" CssClass="tdpadtop" />
                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
                                    <ItemTemplate>
