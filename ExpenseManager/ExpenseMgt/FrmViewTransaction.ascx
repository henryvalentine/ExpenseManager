                              ...
                              <table style="width: 100%">
                                  ...
                                  <tr class="divBackground3">
                                       ...
                                       <td class="tdpad" style="width: 30%">
                                           <asp:DropDownList runat="server" ID="ddlFilterOption" Width="100%" CssClass="text-box"></asp:DropDownList>    
                                       </td>
                          ...
                          <HeaderStyle CssClass="gridHeader" />
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="Payment Status">
                                    <HeaderStyle HorizontalAlign="Left" Width="14%" CssClass="tdpadtop" />
                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
                                    <ItemTemplate>
					...
					<table style="border-style: none; border-color: inherit; border-width: 1px; width: 100%; padding: 0px; height: 41px;">
						<tr>
							<td style="width: 40%" class="tdpad" >
							    ...
							    <b style="color: #333;"> Transaction:</b>&nbsp;   <asp:Label ID ="lblTransactionTitle" style="width: 100%; color: #038103" runat="server" Text=""></asp:Label>
                                </div> 
							</td>
                               ...
                               <table style="width: 100%">
                                   <tr>
                                       <td style="width: 50%">
                                          ...
                                          <b style="color: #333;">Requested Total Amount:</b>&nbsp;<label id="lblRequestedAmmount" style=" width: 100%; color: #038103" runat="server"></label>

                                         
                                       </td>
                                       <td style="width: 50%">

                                         <b style="color: #333;">Approved Total Amount:</b>&nbsp;<label id="lblApprovedTotalAmount" style=" width: 100%; color: #038103" runat="server"></label> 
              ...
              ShowFooter="True" Width="100%">
                ...
                <HeaderStyle CssClass="gridHeader" />
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="Transaction Item" >
